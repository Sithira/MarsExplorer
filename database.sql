...
ALTER TABLE "Mini-TES" ADD CONSTRAINT "Mini-TES_fk0" FOREIGN KEY ("sensor_id") REFERENCES "Sensor"("id") ON DELETE CASCADE;
ALTER TABLE "Mini-TES" ADD CONSTRAINT "Mini-TES_fk1" FOREIGN KEY ("nav_id") REFERENCES "Nav"("id") ON DELETE CASCADE;
...
ALTER TABLE "Computer"
    ADD ("eeprom" VARCHAR2(50),
         "dram" VARCHAR2(50),
         "flash" VARCHAR2(50)
         );

ALTER TABLE "Rover"
    ADD ("width" VARCHAR2(50),
         "height" VARCHAR2(50),
         "length" VARCHAR2(50)
         );