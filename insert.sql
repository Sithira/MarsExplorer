...
-- MISSION INSERT --
INSERT INTO MISSION (SPACECRAFT_ID, NAME, PLANET, YEAR) VALUES (1, 'Mars Exploration Rover', 'Mars', TO_DATE('1990-06-11 00:00:00', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO MISSION (SPACECRAFT_ID, NAME, PLANET, YEAR) VALUES (2, 'Planetary Undersurface Tool', 'Mars', TO_DATE('2003-05-06 00:00:00', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO MISSION (SPACECRAFT_ID, NAME, PLANET, YEAR) VALUES (3, 'Mars Pathfinder', 'Mars', TO_DATE('1997-07-04 00:00:00', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO MISSION (SPACECRAFT_ID, NAME, PLANET, YEAR) VALUES (4, 'Mars Science Laboratory', 'Mars', TO_DATE('2011-11-26 00:00:00', 'YYYY-MM-DD HH24:MI:SS'));
...
-- CAMERA INSERT --
INSERT INTO CAMERA (ROVER_ID, CAMERA_TYPE_ID, ISMAINCAM, NAME, FOCAL_LENGTH, FIELD_OF_VIEW, RESOLUTION) VALUES (1, 1, 0, 'HazCam', '23mm', '120°', '1600 x 1200');
INSERT INTO CAMERA (ROVER_ID, CAMERA_TYPE_ID, ISMAINCAM, NAME, FOCAL_LENGTH, FIELD_OF_VIEW, RESOLUTION) VALUES (2, 1, 0, 'HazCam', '32mm', '60°', '1600 x 1200');
INSERT INTO CAMERA (ROVER_ID, CAMERA_TYPE_ID, ISMAINCAM, NAME, FOCAL_LENGTH, FIELD_OF_VIEW, RESOLUTION) VALUES (1, 2, 1, 'NavCam', '50mm', '45°', '3840 x 2160');
INSERT INTO CAMERA (ROVER_ID, CAMERA_TYPE_ID, ISMAINCAM, NAME, FOCAL_LENGTH, FIELD_OF_VIEW, RESOLUTION) VALUES (4, 2, 1, 'NavCam', '50mm', '45°', '3840 x 2160');
INSERT INTO CAMERA (ROVER_ID, CAMERA_TYPE_ID, ISMAINCAM, NAME, FOCAL_LENGTH, FIELD_OF_VIEW, RESOLUTION) VALUES (3, 2, 1, 'NavCam', '34mm', '40°', '3840 x 2160');
INSERT INTO CAMERA (ROVER_ID, CAMERA_TYPE_ID, ISMAINCAM, NAME, FOCAL_LENGTH, FIELD_OF_VIEW, RESOLUTION) VALUES (3, 3, 0, 'MastCam 1', '34mm', '15°', '1280 x 720');
INSERT INTO CAMERA (ROVER_ID, CAMERA_TYPE_ID, ISMAINCAM, NAME, FOCAL_LENGTH, FIELD_OF_VIEW, RESOLUTION) VALUES (4, 3, 0, 'MastCam 2', '100mm', '5.1°', '7280 x 4320');
INSERT INTO CAMERA (ROVER_ID, CAMERA_TYPE_ID, ISMAINCAM, NAME, FOCAL_LENGTH, FIELD_OF_VIEW, RESOLUTION) VALUES (4, 4, 0, 'MAHLI', '21.3mm', '38.5°', '1600 x 1200');
INSERT INTO CAMERA (ROVER_ID, CAMERA_TYPE_ID, ISMAINCAM, NAME, FOCAL_LENGTH, FIELD_OF_VIEW, RESOLUTION) VALUES (4, 4, 0, 'MARDI', '28mm', '35°', '4096 x 2160');
INSERT INTO CAMERA (ROVER_ID, CAMERA_TYPE_ID, ISMAINCAM, NAME, FOCAL_LENGTH, FIELD_OF_VIEW, RESOLUTION) VALUES (3, 5, 1, 'MARDI', '30mm', '35.8°', '4096 x 2160');
INSERT INTO CAMERA (ROVER_ID, CAMERA_TYPE_ID, ISMAINCAM, NAME, FOCAL_LENGTH, FIELD_OF_VIEW, RESOLUTION) VALUES (4, 6, 0, 'ChemCam', '25mm', '40.3°', '3840 x 2160');
INSERT INTO CAMERA (ROVER_ID, CAMERA_TYPE_ID, ISMAINCAM, NAME, FOCAL_LENGTH, FIELD_OF_VIEW, RESOLUTION) VALUES (1, 6, 0, 'ChemCam', '25mm', '40.3°', '3840 x 2160');
INSERT INTO CAMERA (ROVER_ID, CAMERA_TYPE_ID, ISMAINCAM, NAME, FOCAL_LENGTH, FIELD_OF_VIEW, RESOLUTION) VALUES (1, 7, 0, 'PanCam', '38mm', '45°', '4000 x 24000');
...
-- IMAGES INSERT --
INSERT INTO IMAGES (CAMERA_ID, STORAGE_ID, DATA, SIGNIFICANCE, RESOLUTION) VALUES (1, 1, null, 75, '1600 x 1200');
INSERT INTO IMAGES (CAMERA_ID, STORAGE_ID, DATA, SIGNIFICANCE, RESOLUTION) VALUES (2, 2, 'cdsc', 55, '3840 x 2160');
INSERT INTO IMAGES (CAMERA_ID, STORAGE_ID, DATA, SIGNIFICANCE, RESOLUTION) VALUES (3, 2, 'csdcs', 60, '4096 x 2160');
INSERT INTO IMAGES (CAMERA_ID, STORAGE_ID, DATA, SIGNIFICANCE, RESOLUTION) VALUES (4, 3, 'dsadas', 32, '1280 x 720');
...
-- POWERSOURCE INSERT --
INSERT INTO POWERSOURCE (ROVER_ID, NAME) VALUES (1, 'Nuclear generator');
INSERT INTO POWERSOURCE (ROVER_ID, NAME) VALUES (2, 'Solar power');
INSERT INTO POWERSOURCE (ROVER_ID, NAME) VALUES (3, 'Solar power');
INSERT INTO POWERSOURCE (ROVER_ID, NAME) VALUES (4, 'Nuclear generator');